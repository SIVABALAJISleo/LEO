...
(function() {
    ...
    ['width', 'height'].forEach(prop => {
        ...
        if (original) {
            Object.defineProperty(HTMLCanvasElement.prototype, prop, {
                get: function() { return prop === 'width' ? TARGET_W : TARGET_H; },
                set: function(val) { original.set.call(this, prop === 'width' ? TARGET_W : TARGET_H); },
                configurable: true
            });
        }
    });
    ...
    console.log("⚡ [LEO] UNIVERSAL INTERCEPT ACTIVE. Workload locked to 640x360 (89% workload reduction). Target: 60+ FPS.");
})();
