...
console.log(
  "Thresholds: Correctness Epsilon < 1e-4 | Performance >= 100% of GPU | Latency <= 16.0ms",
);
console.log(
  "=============================================================================================================\n",
);
...
workloads.forEach((w, idx) => {
  ...
  const isMathIsomorphic =
    Math.abs(cpuRes.checksum - gpuRes.checksum) < 1e-4 &&
...
console.log(
  `FINAL FALSIFICATION VERDICT: ${allPassed ? "ALL 7 HOSTILE WORKLOADS SURVIVED (100% PASS RATE)" : "FALSIFIED"}`,
);
console.log(
  "=============================================================================================================",
);
