...
| `COLI_THINK`         | `0` (off)         | Make thinking the default when the client sends _neither_ `reasoning_effort` nor `enable_thinking`. Any explicit client value still wins.                                                                                                                                                                                                                                                                         |
