...
_The canonical reference for the `GRAMMAR=` draft source (method F). History: idea in
...
measurements and corrections in [#146](https://github.com/JustVugg/colibri/issues/146)._
...
constrains sampling: forced spans are _verified by the target model_, so a wrong,
...
_all_ positions in the verify batch, and structural tokens route heavily into experts
...
_constraining output_, and Outlines' coalescence does the analogous FSM move. What
