...
from high_perf_intel_ai.inference import HighPerfEngine
from controlled_ai_pipeline.scorer import RubricEngine, Scorer
...
class ControlledKernel:
    ...
    async def run_pipeline(self, query: str) -> Dict[str, Any]:
        ...
        sub_qs = json.loads("".join(list(self.engine.generate(query, decomp_prompt))))
