...
try:
    ...
    try:
        from archive_engines.orchestration.world_axioms import WorldAxioms # type: ignore
        from archive_engines.orchestration.pipeline_geometry import PipelineGeometry # type: ignore
        from archive_engines.orchestration.pipeline_semantics import PipelineSemantics # type: ignore
        from archive_engines.orchestration.authorship_boundary import AuthorshipBoundary # type: ignore
        from archive_engines.orchestration.visibility_manager import VisibilityManager # type: ignore
        from archive_engines.orchestration.specular_governor import SpecularGovernor # type: ignore
        from archive_engines.orchestration.chaos_containment import ChaosContainment # type: ignore
        from archive_engines.orchestration.outcome_lookup import OutcomeLookup # type: ignore
    except ImportError:
        class Mock:
