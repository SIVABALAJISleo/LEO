...
try:
    ...
    try:
        ...
        from archive_engines.orchestration.hyper_engine import HyperEngine, jit_propagate # type: ignore
        from archive_engines.orchestration.compressed_dag import CompressedDAG # type: ignore
    except ImportError:
        class Mock:
