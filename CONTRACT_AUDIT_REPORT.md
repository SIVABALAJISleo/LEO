...
| **-**  | _[Negative Control: Raw FP32 GEMM]_ |            ✅ YES            |                ❌ NO                |     $\Delta \le 10^{-4}$      |       Exact Math       |       **$74.6\,\text{GFLOPS}$**        | **$12,720.0\,\text{GFLOPS}$** |    🔴 **FAIL (Raw Compute)**    |
...
| **-**  | _[Negative Control: Raw FP16 GEMM]_ |            ✅ YES            |                ❌ NO                |         FP16 Bitwise          |       Exact Math       |       **$119.4\,\text{GFLOPS}$**       | **$25,400.0\,\text{GFLOPS}$** |    🔴 **FAIL (Raw Compute)**    |
...
| **-**  | _[Dense White Noise FFT]_           |            ✅ YES            |          ❌ NO (Fallback)           |         Bitwise Float         |       Exact Math       |           $4.14\,\text{ms}$            |       $1.20\,\text{ms}$       | 🟡 **TOLERABLE (CPU Fallback)** |
...
| **-**  | _[Exact Reduction Contract]_        |            ✅ YES            |           ❌ NO (`EXACT`)           |        $\Delta = 0.0$         |      Bitwise FP64      |           $9.92\,\text{ms}$            |       $1.20\,\text{ms}$       |   🔴 **FAIL (Raw Memory BW)**   |
...
| **-**  | _[100-SPP Ground Truth Render]_     |            ✅ YES            |                ❌ NO                |      Bitwise Monte Carlo      |      Ground Truth      |         **$4.200\,\text{s}$**          |     **$0.280\,\text{s}$**     |  🔴 **FAIL (Raw RT Silicon)**   |
...
| **-**  | _[Direct $O(N^2)$ Pairwise Sum]_    |            ✅ YES            |                ❌ NO                |        Exact pairwise         |     Exact Physics      |       **$265\,\text{steps/s}$**        |  **$1,250\,\text{steps/s}$**  |    🔴 **FAIL (Raw Compute)**    |
