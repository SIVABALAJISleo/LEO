...
const PersonalizationPage = () => {
  const { settings, behaviors, recommendations, isLoading, updateSettings } =
    ...
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Customize your experience with behavioral tracking and recommendations
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm">Behaviors Tracked</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold capitalize">
              {settings?.layout_preference || "default"}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="preferences">
        ...
        <TabsContent value="preferences" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Select
                  value={settings?.layout_preference || "default"}
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Sparkles className="h-5 w-5" /> Notifications
              </CardTitle>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <LayoutGrid className="h-5 w-5" /> Feature Flags
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <TabsContent value="recommendations" className="space-y-4">
          {recommendations.length === 0 ? (
            <EmptyState
              ...
              description="Use the platform more to receive personalized recommendations"
              icon={Sparkles}
            />
          ) : (
                ...
                <Card key={r.id}>
                  <CardContent className="flex justify-between items-center py-4">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant={
                          r.is_dismissed ? "secondary" : r.is_applied ? "default" : "outline"
                        }
                      >
                        {r.is_dismissed ? "Dismissed" : r.is_applied ? "Applied" : "Pending"}
                      </Badge>
                      {!r.is_dismissed && !r.is_applied && <Button size="sm">Apply</Button>}
                    </div>
                  </CardContent>
                </Card>
              ))}
