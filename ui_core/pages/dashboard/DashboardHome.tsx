    ...
    return (
      <div className="flex-1 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <button onClick={refreshAll} className="text-primary hover:underline">
            Try again
          </button>
        </div>
      </div>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            onClick={() => (window.location.href = "/dashboard/leo-master")}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <SystemStatusCard metrics={systemMetrics} onRefresh={refreshAll} />
        <PerformanceOverview metrics={performanceMetrics} activeJobs={activeJobs} />
      </div>
      ...
      {/* Module Cards Grid */}
      <ModuleCards statuses={moduleStatuses} configs={moduleConfigs} />
