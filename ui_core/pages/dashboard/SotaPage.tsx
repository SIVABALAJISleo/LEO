    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground max-w-3xl">
          Interact with State-of-the-Art (SOTA) multimodal models. Test out semantic instance
          segmentation via `yolov8n-seg` and text-to-image Natural Language dialogue through
          Salesforce's Vision-Language `BLIP` transformers.
        </p>
      </div>
