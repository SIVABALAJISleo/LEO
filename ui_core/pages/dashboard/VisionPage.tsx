    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground max-w-2xl">
          Upload an image to process it through the local YOLOv8 neural network for real-time entity
          detection, or apply CPU-accelerated high-resolution upscaling.
        </p>
      </div>
              ...
              <div className="mt-6 space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {detections.map((det, i) => (
                    <div
                      key={i}
                      className="bg-background border rounded-lg p-3 text-sm flex items-center justify-between shadow-sm animate-in slide-in-from-bottom-2"
