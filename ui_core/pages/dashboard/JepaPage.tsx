    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground max-w-3xl">
          Joint Embedding Predictive Architecture (JEPA) evaluates visual data internally within a
          high-dimensional abstract space ($h_c$ and $h_t$), rather than relying on pixel-level
          similarities. Upload a Context and Target image below to test their semantic distance.
        </p>
      </div>
              ...
              <div className="space-y-4 animate-in slide-in-from-right-8 duration-500">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-wider text-muted-foreground flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs normal-case opacity-50 font-mono">
                      Sim(h_c, h_t) = {similarityData.score}
                    </span>
                  </p>
