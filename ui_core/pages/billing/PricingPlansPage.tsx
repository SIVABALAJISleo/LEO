...
const PricingPlansPage = () => {
  ...
  const formatPrice = (plan: (typeof PLANS)[0]) => {
    ...
    const priceMax =
      billingPeriod === "yearly" && plan.yearlyPriceMax ? plan.yearlyPriceMax : plan.priceMax;
    ...
    <div className="space-y-8 p-6">
        ...
        {PLANS.map((plan) => (
          ...
          >
            ...
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription>
                <span className="text-2xl font-bold text-foreground">{formatPrice(plan)}</span>
                {plan.price !== null && (
      ...
      <div className="text-center max-w-2xl mx-auto">
        <p className="text-muted-foreground">
          Need help choosing?{" "}
          <Button variant="link" onClick={() => navigate("/billing/enterprise")}>
