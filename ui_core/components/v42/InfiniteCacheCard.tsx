...
import { InfiniteCacheEngine, InfiniteCacheMetrics } from '../../src/v40/engines/infiniteCacheEngine';
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span style={{ fontSize: '0.8rem', color: '#aaa', textTransform: 'uppercase' }}>Hit Rate</span>
          ...
          return (
            <div key={idx} style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem' }}>
                ...
                <span style={{ fontWeight: 600, color: colors[idx] }}>{tier.hitCount.toLocaleString()} hits</span>
              </div>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
          <span style={{ fontSize: '0.8rem', color: '#888', textTransform: 'uppercase' }}>Compute Avoided</span>
          <span style={{ fontSize: '1.5rem', fontWeight: 700, color: '#00ff88' }}>
            {metrics.estimatedTFlopsSaved.toLocaleString()} <span style={{ fontSize: '0.9rem', color: '#aaa', fontWeight: 400 }}>TFLOPs</span>
          </span>
        </div>
