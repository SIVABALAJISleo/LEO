...
import {
  ...
  MambaTelemetry,
  SpeculativeMode,
} from "../../src/v40/engines/mambaHybridEngine";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px", zIndex: 1 }}>
            ...
            {["OFF", "EAGLE-3", "PEARL"].map((mode) => (
              <button
                ...
                style={{
                  flex: 1,
                  background:
                    specMode === mode ? "rgba(187, 0, 255, 0.3)" : "rgba(255,255,255,0.05)",
                  border:
                    specMode === mode ? "1px solid #bb00ff" : "1px solid rgba(255,255,255,0.1)",
        ...
        {metrics && (
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: "1.4rem", fontWeight: 700, color: "#00d2ff" }}>
                {metrics.tokensPerSec.toFixed(1)}{" "}
                <span style={{ fontSize: "0.8rem", color: "#aaa" }}>t/s</span>
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: "1.4rem", fontWeight: 700, color: "#00ff88" }}>
                {metrics.speedupVsTransformer.toFixed(1)}x{" "}
                <span style={{ fontSize: "0.8rem", color: "#aaa" }}>faster</span>
              </div>
            </div>
          </div>
        )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "4px" }}>
          ...
          >
            {generatedText || (
              <span style={{ color: "#666", fontStyle: "italic" }}>Output will appear here...</span>
            )}
          </div>
        </div>
      </div>
