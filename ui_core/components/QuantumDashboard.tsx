      ...
      >
        ...
        <div className="relative z-10 space-y-4 max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">
            Full-power AI on{" "}
            <span style={{ color: nvidiaTokens.colors.accent.nvidiaGreen }}>
              commodity hardware.
            </span>
          </h1>
          <p className="text-sm md:text-base text-slate-300 leading-relaxed font-normal">
            Bypassing traditional GPU walls through software-first intelligence. 99.3% compute
            avoided via semantic caching, topological hypergraph reasoning, and vectorized ternary
            execution.
          </p>
        </div>
      </section>
        ...
        {[
          {
            ...
            description:
              "50K+ entities with 120K+ multi-hop interference relationships for instant 2.3ms context synthesis.",
            icon: Database,
            badge: "GraphRAG Core",
          },
          {
            ...
            description:
              "Dynamic TF-IDF & VSA routing bypassing heavy LLM inference for 99%+ of queries.",
            icon: Layers,
            badge: "MoE Router",
          },
          {
            ...
            description:
              "OneAPI Zero-Copy memory pinning & BitNet 1.58-bit SIMD acceleration on Intel Iris Xe.",
            icon: Shield,
            badge: "OpenVINO SIMD",
          },
        ].map((card, idx) => {
