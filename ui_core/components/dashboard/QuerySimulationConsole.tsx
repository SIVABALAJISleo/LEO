    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="bg-card border rounded-xl shadow-sm p-6 flex flex-col h-full">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Test the runtime intelligence router. Type a query to see how the system avoids GPU usage
          by routing through the 12-layer OS.
        </p>
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 p-3 rounded-md">
                ...
                <p className="font-mono text-sm">
                  {response.compute_avoided ? "Yes (Zero Cloud GPU)" : "No"}
                </p>
              </div>
            </div>
          </div>
