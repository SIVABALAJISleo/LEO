    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh]">
        <DialogHeader>
          ...
          <DialogDescription>Configure and submit a new GPU inference job.</DialogDescription>
        </DialogHeader>
        ...
        <ScrollArea className="max-h-[60vh] pr-4">
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-2">
              ...
              {errors.model_id && <p className="text-xs text-red-500">{errors.model_id}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                ...
                {errors.input_text && <span className="text-red-500">{errors.input_text}</span>}
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {MODULE_NAMES.map((module) => (
                  ...
                  >
                    ...
                    />
                    <label htmlFor={module} className="text-xs cursor-pointer flex-1 truncate">
                      {module}
                    </label>
                  </div>
                ))}
