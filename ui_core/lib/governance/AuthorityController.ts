...
export class AuthorityController {
    ...
    evaluate(
        ...
        if (effectiveLevel === AuthorityLevel.AUTOMATED &&
            domainReliability < this.AUTOMATED_RELIABILITY_FLOOR) {
            effectiveLevel = AuthorityLevel.ASSISTED;
        }

        if (effectiveLevel === AuthorityLevel.ASSISTED &&
        ...
        return {
            ...
            requiresHuman,
            terminalAction,
            reason: this.buildReason(effectiveLevel, domainStatus, domainReliability, confidence, driftActive),
        };
    }
