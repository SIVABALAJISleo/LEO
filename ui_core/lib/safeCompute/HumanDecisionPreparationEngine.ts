...
export type DecisionCategory =
  "financial" | "legal" | "medical" | "safety" | "operational" | "strategic";
...
class HumanDecisionPreparationEngine {
  ...
  async prepareDecision(
    ...
    const recommendation = this.generateRecommendation(predictedOutcomes, riskAssessment, category);
  ...
  private assessRisk(outcomes: PredictedOutcome[], category: DecisionCategory): RiskAssessment {
    ...
    return {
      ...
      residualRisk:
        level === "critical" ? 0.7 : level === "high" ? 0.4 : level === "medium" ? 0.2 : 0.05,
    };
  }
