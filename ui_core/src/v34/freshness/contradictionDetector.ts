...
export class ContradictionDetector {
  detectContradiction(
    ...
    const aContainsActive =
      textALower.includes("active") ||
      textALower.includes("supported") ||
      textALower.includes("enabled");
    const bContainsDisabled =
      textBLower.includes("disabled") ||
      textBLower.includes("deprecated") ||
      textBLower.includes("removed");
