...
export function ScientificValidationDashboard() {
  ...
  const [activeSubTab, setActiveSubTab] = useState<
    "configs" | "datasets" | "evidence" | "security"
  >("configs");
  ...
  const handleDownloadAuditBundle = () => {
    ...
    setTimeout(() => {
      const dataStr =
        ...
        encodeURIComponent(JSON.stringify(report.auditBundle, null, 2));
      ...
      setDownloadLog(
        `Successfully generated and downloaded bundle ${report.auditBundle.bundleId}.json! External auditors can now rerun simulations.`,
      );
    }, 1200);
  };
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-slate-500 text-sm font-mono">
              Independent Reproducibility & Scientific Validation Lab
            </span>
          </div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Guarantees independent external validation of platform capabilities via configurations,
            registries, and logs.
          </p>
        </div>
          ...
          <div className="no-print grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col justify-between hover:border-violet-500/50 transition-all">
              <span className="text-slate-400 text-[10px] uppercase block font-mono">
                Reasoning (Target: {targets.reasoning}%)
              </span>
              <span className="text-2xl font-black font-mono text-slate-100 mt-2">
                {report.reasoningReport.overallAccuracy.toFixed(2)}%
              </span>
              <div className="mt-2 w-full bg-slate-950 h-1.5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-violet-500"
                  style={{ width: `${report.reasoningReport.overallAccuracy}%` }}
                />
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col justify-between hover:border-violet-500/50 transition-all">
              <span className="text-slate-400 text-[10px] uppercase block font-mono">
                Memory (Target: {targets.memory}%)
              </span>
              <span className="text-2xl font-black font-mono text-slate-100 mt-2">
                {report.memoryReport.overallMemoryConsistency.toFixed(2)}%
              </span>
              <div className="mt-2 w-full bg-slate-950 h-1.5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-violet-500"
                  style={{ width: `${report.memoryReport.overallMemoryConsistency}%` }}
                />
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col justify-between hover:border-violet-500/50 transition-all">
              <span className="text-slate-400 text-[10px] uppercase block font-mono">
                Search (Target: {targets.search}%)
              </span>
              <span className="text-2xl font-black font-mono text-slate-100 mt-2">
                {report.searchRagReport.searchAccuracy.toFixed(2)}%
              </span>
              <div className="mt-2 w-full bg-slate-950 h-1.5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-violet-500"
                  style={{ width: `${report.searchRagReport.searchAccuracy}%` }}
                />
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col justify-between hover:border-violet-500/50 transition-all">
              <span className="text-slate-400 text-[10px] uppercase block font-mono">
                RAG (Target: {targets.rag}%)
              </span>
              <span className="text-2xl font-black font-mono text-slate-100 mt-2">
                {report.searchRagReport.ragAccuracy.toFixed(2)}%
              </span>
              <div className="mt-2 w-full bg-slate-950 h-1.5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-violet-500"
                  style={{ width: `${report.searchRagReport.ragAccuracy}%` }}
                />
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col justify-between hover:border-violet-500/50 transition-all">
              <span className="text-slate-400 text-[10px] uppercase block font-mono">
                Agent (Target: {targets.agent}%)
              </span>
              <span className="text-2xl font-black font-mono text-slate-100 mt-2">
                {report.enterpriseReport.agentSuccessRate.toFixed(2)}%
              </span>
              <div className="mt-2 w-full bg-slate-950 h-1.5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-violet-500"
                  style={{ width: `${report.enterpriseReport.agentSuccessRate}%` }}
                />
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col justify-between hover:border-violet-500/50 transition-all">
              <span className="text-slate-400 text-[10px] uppercase block font-mono">
                Reliability (Target: {targets.enterprise}%)
              </span>
              <span className="text-2xl font-black font-mono text-slate-100 mt-2">
                {report.enterpriseReport.slaComplianceRate.toFixed(2)}%
              </span>
              <div className="mt-2 w-full bg-slate-950 h-1.5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-violet-500"
                  style={{ width: `${report.enterpriseReport.slaComplianceRate}%` }}
                />
              </div>
            </div>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex flex-col justify-between hover:border-violet-500/50 transition-all">
              <span className="text-slate-400 text-[10px] uppercase block font-mono">
                Hallucinations (Target: &lt;{targets.hallucination}%)
              </span>
              <span className="text-2xl font-black font-mono text-slate-100 mt-2">
                {report.hallucinationReport.overallHallucinationRate.toFixed(2)}%
              </span>
              <div className="mt-2 w-full bg-slate-950 h-1.5 rounded-full overflow-hidden">
                <div
                  className="h-full bg-rose-500"
                  style={{
                    width: `${(report.hallucinationReport.overallHallucinationRate / 2) * 100}%`,
                  }}
                />
              </div>
            </div>
          ...
          <div className="no-print grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-xl flex flex-col justify-between">
              <div>
                ...
                {activeSubTab === "configs" && (
                  <div className="space-y-4">
                    <p className="text-slate-400 text-xs">
                      The execution environment variables below are seeded and locked into the
                      compiler target to ensure identical outputs on all independent runs.
                    </p>
                    <div className="grid grid-cols-2 gap-4 text-xs font-mono">
                      <div className="bg-slate-950 p-3 rounded-lg border border-slate-850">
                        <span className="text-slate-500 text-[9px] block">VERIFICATION SEED</span>
                        <span className="text-slate-300 font-bold text-violet-400">
                          {report.config.seed}
                        </span>
                      </div>
                      <div className="bg-slate-950 p-3 rounded-lg border border-slate-850">
                ...
                {activeSubTab === "datasets" && (
                  <div className="space-y-3">
                    <p className="text-slate-400 text-xs mb-3">
                      Registered reference dataset profiles. Every validation laboratory check must
                      reference a registered database hash below.
                    </p>
                    <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
                      {report.datasets.map((dataset, idx) => (
                        <div
                          key={idx}
                          className="p-3 border border-slate-950 bg-slate-950/40 rounded-lg flex justify-between items-center text-xs font-mono"
                        >
                          <div>
                            <span className="text-slate-200 font-bold block">{dataset.name}</span>
                            <span className="text-slate-500 text-[9px] block">
                              Version: {dataset.version} • Created: {dataset.creationDate} •
                ...
                {activeSubTab === "evidence" && (
                  <div className="space-y-3">
                    <p className="text-slate-400 text-xs">
                      Live evidence package logs recording input/expected parameters during RAG
                      query validations.
                    </p>
                    <div className="bg-slate-950 border border-slate-850 rounded-lg p-4 space-y-3 font-mono text-xs max-h-60 overflow-y-auto pr-1">
                      <div>
                        <span className="text-slate-500 text-[9px] block">
                          TEST CASE: TC-V28-R01
                        </span>
                        <span className="text-slate-400">Input: </span>
                        <span className="text-slate-300">
                          "Run WebGPU tensor kernel dependency checks"
                        </span>
                        <div className="flex gap-4 mt-1.5 text-[10px]">
                          <span className="text-slate-500">
                            Expected: <span className="text-emerald-400 font-bold">MATCH</span>
                          </span>
                      ...
                      <div className="border-t border-slate-900 pt-3">
                        <span className="text-slate-500 text-[9px] block">
                          TEST CASE: TC-V28-R02
                        </span>
                        <span className="text-slate-400">Input: </span>
                        <span className="text-slate-300">
                          "Retrieve Lean proof checker constraints"
                        </span>
                        <div className="flex gap-4 mt-1.5 text-[10px]">
                          <span className="text-slate-500">
                            Expected: <span className="text-emerald-400 font-bold">MATCH</span>
                ...
                {activeSubTab === "security" && (
                  <div className="space-y-3">
                    <p className="text-slate-400 text-xs mb-3">
                      Phase 9 Red Team validation logs. Measures adversarial containment rates
                      ...
                      {report.securityReport.vectors.map((v, i) => (
                        ...
                        >
                          <div>
                            ...
                            <span className="text-slate-500 text-[9px] block">
                              Attacks: {v.payloadCount} • Blocked: {v.blockedCount}
                            </span>
                          </div>
                          <div className="text-right shrink-0 flex items-center gap-3">
                            ...
                            <span className="px-1 py-0.5 rounded text-[8px] bg-emerald-950 text-emerald-400 border border-emerald-900/30">
                              CONTAINED
                            </span>
                          </div>
                        </div>
              ...
              <div className="mt-6 border-t border-slate-800 pt-4 flex flex-col md:flex-row justify-between text-[11px] text-slate-500 font-mono gap-3">
                ...
                <span className="text-emerald-400 font-bold flex items-center gap-1">
                  <CheckCircle className="w-3.5 h-3.5" /> Uptime:{" "}
                  {report.enterpriseReport.uptimePercentage}%
                </span>
            ...
            <div className="no-print lg:col-span-4 space-y-6">
                ...
                <div className="space-y-3 font-mono text-xs">
                  <div className="flex flex-col bg-slate-950 p-2.5 rounded border border-slate-850">
                    ...
                    <span className="text-slate-300 font-bold text-xs mt-1">
                      [{report.claimsVerification.reasoning.confidenceInterval[0]}% -{" "}
                      {report.claimsVerification.reasoning.confidenceInterval[1]}%]
                    </span>
                    <span className="text-slate-500 text-[8px] mt-0.5">
                      Reproducibility index:{" "}
                      {report.claimsVerification.reasoning.reproducibilityIndex}%
                    </span>
                  </div>
                  <div className="flex flex-col bg-slate-950 p-2.5 rounded border border-slate-850">
                    <span className="text-slate-500 text-[9px] uppercase">Memory (99% CI)</span>
                    <span className="text-slate-300 font-bold text-xs mt-1">
                      [{report.claimsVerification.memory.confidenceInterval[0]}% -{" "}
                      {report.claimsVerification.memory.confidenceInterval[1]}%]
                    </span>
                    <span className="text-slate-500 text-[8px] mt-0.5">
                      Reproducibility index: {report.claimsVerification.memory.reproducibilityIndex}
                      %
                    </span>
                  </div>
                  <div className="flex flex-col bg-slate-950 p-2.5 rounded border border-slate-850">
                    ...
                    <span className="text-slate-300 font-bold text-xs mt-1">
                      [{report.claimsVerification.enterprise.confidenceInterval[0]}% -{" "}
                      {report.claimsVerification.enterprise.confidenceInterval[1]}%]
                    </span>
                    <span className="text-slate-500 text-[8px] mt-0.5">
                      Reproducibility index:{" "}
                      {report.claimsVerification.enterprise.reproducibilityIndex}%
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-lg flex flex-col justify-between relative overflow-hidden">
                ...
                <div>
                  <span className="text-slate-500 text-[9px] font-mono block uppercase mb-1">
                    Phase 11 Audit Package
                  </span>
                  <h3 className="text-xs font-bold text-slate-200 font-mono mb-2 flex items-center gap-1.5">
                    <Download className="text-violet-400 w-4 h-4 animate-bounce" /> Export Audit
                    Bundle
                  </h3>
                  <p className="text-slate-400 text-[10px] leading-relaxed mb-4">
                    Compile baseline configuration parameters, registered datasets, and logs into a
                    single package. Independent external auditors can rerun configurations to obtain
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="print-header border-b border-slate-800 pb-6 text-center">
                ...
                <p className="text-slate-400 text-xs font-mono mt-1 print:text-slate-600">
                  Antigravity AI Platform Validation Sweep • Bundle ID:{" "}
                  {report.auditBundle.bundleId}
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex justify-between items-center bg-slate-950/60 p-2.5 rounded border border-slate-850 print:bg-white print:border-black">
                    <div>
                      ...
                      <span className="text-slate-500 text-[9px]">
                        Interval: [{report.claimsVerification.reasoning.confidenceInterval[0]}% -{" "}
                        {report.claimsVerification.reasoning.confidenceInterval[1]}%]
                      </span>
                    </div>
                    <div className="text-right flex items-center gap-3">
                      <span className="text-slate-300 font-mono font-bold print:text-black">
                        {report.reasoningReport.overallAccuracy}%
                      </span>
                  ...
                  <div className="flex justify-between items-center bg-slate-950/60 p-2.5 rounded border border-slate-850 print:bg-white print:border-black">
                    <div>
                      ...
                      <span className="text-slate-500 text-[9px]">
                        Interval: [{report.claimsVerification.memory.confidenceInterval[0]}% -{" "}
                        {report.claimsVerification.memory.confidenceInterval[1]}%]
                      </span>
                    </div>
                    <div className="text-right flex items-center gap-3">
                      <span className="text-slate-300 font-mono font-bold print:text-black">
                        {report.memoryReport.overallMemoryConsistency}%
                      </span>
                  ...
                  <div className="flex justify-between items-center bg-slate-950/60 p-2.5 rounded border border-slate-850 print:bg-white print:border-black">
                    <div>
                      ...
                      <span className="text-slate-500 text-[9px]">
                        Interval: [{report.claimsVerification.search.confidenceInterval[0]}% -{" "}
                        {report.claimsVerification.search.confidenceInterval[1]}%]
                      </span>
                    </div>
                    <div className="text-right flex items-center gap-3">
                      <span className="text-slate-300 font-mono font-bold print:text-black">
                        {report.searchRagReport.searchAccuracy}%
                      </span>
                  ...
                  <div className="flex justify-between items-center bg-slate-950/60 p-2.5 rounded border border-slate-850 print:bg-white print:border-black">
                    <div>
                      ...
                      <span className="text-slate-500 text-[9px]">
                        Interval: [{report.claimsVerification.rag.confidenceInterval[0]}% -{" "}
                        {report.claimsVerification.rag.confidenceInterval[1]}%]
                      </span>
                    </div>
                    <div className="text-right flex items-center gap-3">
                      <span className="text-slate-300 font-mono font-bold print:text-black">
                        {report.searchRagReport.ragAccuracy}%
                      </span>
                  ...
                  <div className="flex justify-between items-center bg-slate-950/60 p-2.5 rounded border border-slate-850 print:bg-white print:border-black">
                    <div>
                      ...
                      <span className="text-slate-500 text-[9px]">
                        Interval: [{report.claimsVerification.agent.confidenceInterval[0]}% -{" "}
                        {report.claimsVerification.agent.confidenceInterval[1]}%]
                      </span>
                    </div>
                    <div className="text-right flex items-center gap-3">
                      <span className="text-slate-300 font-mono font-bold print:text-black">
                        {report.enterpriseReport.agentSuccessRate}%
                      </span>
                  ...
                  <div className="flex justify-between items-center bg-slate-950/60 p-2.5 rounded border border-slate-850 print:bg-white print:border-black">
                    <div>
                      ...
                      <span className="text-slate-500 text-[9px]">
                        Interval: [{report.claimsVerification.enterprise.confidenceInterval[0]}% -{" "}
                        {report.claimsVerification.enterprise.confidenceInterval[1]}%]
                      </span>
                    </div>
                    <div className="text-right flex items-center gap-3">
                      <span className="text-slate-300 font-mono font-bold print:text-black">
                        {report.enterpriseReport.slaComplianceRate}%
                      </span>
              ...
              <div className="flex justify-between items-end pt-8 text-xs font-mono text-slate-400 print:text-black">
                <div>
                  ...
                  <p>
                    Hash Signature: {report.auditBundle.sha256VerificationSignature.slice(0, 40)}...
                  </p>
                </div>
