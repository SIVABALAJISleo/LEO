...
export class MetaLearningGovernor {
  private pathways: PathMetric[] = [
    {
      pathId: "A1",
      name: "6-Agent Round-Robin Debate",
      category: "agent",
      successCount: 142,
      failureCount: 4,
    ...
    {
      pathId: "A2",
      name: "Direct Single-Agent Critique",
      category: "agent",
      successCount: 98,
      failureCount: 12,
    ...
    {
      pathId: "R1",
      name: "GraphRAG Causal Context Mapping",
      category: "retrieval",
      successCount: 204,
      failureCount: 5,
    ...
    {
      pathId: "R2",
      name: "Direct Semantic Vector Cache Lookup",
      category: "retrieval",
      successCount: 450,
      failureCount: 22,
      avgResponseTimeMs: 5,
    ...
    {
      pathId: "M1",
      name: "Temporal Decay Memory Store",
      category: "memory",
      successCount: 110,
      failureCount: 2,
    ...
    {
      pathId: "P1",
      name: "Critical Path Decomposition Planner",
      category: "planning",
      successCount: 85,
      failureCount: 6,
