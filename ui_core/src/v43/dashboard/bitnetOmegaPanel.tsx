    ...
    <Card className="border-green-500">
      ...
      <CardContent>
        ...
        <Alert className="mt-4 bg-green-50">
          ...
          <AlertDescription>
            NVIDIA H100 delivers 3,958 TFLOPS but burns 700W. BitNet Omega delivers 535x more
            intelligence per joule by using ternary weights {(-1, 0, +1)} and eliminating 99.9% of
            multiplications. In the game that matters (useful output per watt), LEO wins.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
