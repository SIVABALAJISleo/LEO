    ...
    const defaultNodes: TopologicalNode[] = [
      {
        id: "node-1",
        type: "room",
        label: "Docking Zone Alpha",
        connections: ["node-2"],
        properties: { containsCharger: true },
      },
      {
        id: "node-2",
        type: "corridor",
        label: "Main Corridor West",
        connections: ["node-1", "node-3", "node-4"],
        properties: { widthMeters: 2.5 },
      },
      {
        id: "node-3",
        type: "room",
        label: "Silicon Lab Room B",
        connections: ["node-2"],
        properties: { temperatureCelsius: 22.1 },
      },
      {
        id: "node-4",
        type: "zone",
        label: "Assembly Area Delta",
        connections: ["node-2", "node-5"],
        properties: { highVoltageZone: true },
      },
      {
        id: "node-5",
        type: "landmark",
        label: "Structural Pillar 10",
        connections: ["node-4"],
