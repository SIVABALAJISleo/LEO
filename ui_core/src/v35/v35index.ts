...
export type { AvoidanceLevel, AvoidanceResolution, AvoidanceTelemetry } from "./engines/computeAvoidanceEngine";
...
export type { OutputCategory, RetrievedEvidence, RetrievalFirstOutput } from "./engines/retrievalFirstIntelligence";
...
export type { ScientificHypothesis, ScienceEvaluationResult } from "./engines/scientificReasoningLayer";

// === 6. Continuous Knowledge Refresh ===
export { ContinuousKnowledgeRefresh } from "./engines/continuousKnowledgeRefresh";
export type { IngestionState, KnowledgeNode, RefreshReport } from "./engines/continuousKnowledgeRefresh";

// === 7. Real User Feedback Learning ===
export { RealUserFeedbackLearning } from "./engines/realUserFeedbackLearning";
export type { UserFeedbackRecord, FeedbackIntelligenceStats } from "./engines/realUserFeedbackLearning";

// === 8. Hardware-Aware Runtime ===
export { HardwareAwareRuntime } from "./engines/hardwareAwareRuntime";
export type { ExecutionDevice, HardwareSpecification, RuntimeOptimization } from "./engines/hardwareAwareRuntime";

// === 9. Unknown Knowledge Management ===
export { UnknownKnowledgeManagement } from "./engines/unknownKnowledgeManagement";
export type { VerificationTrigger, UncertaintyResolution } from "./engines/unknownKnowledgeManagement";
