  ...
  private seedDatasets() {
    this.items = [
      ...
      },
      {
        ...
        source: "prod-logs",
        payload:
          "WARN 2026-06-10T22:18:04Z: Memory state consolidation collision warning on minhash check.",
      ...
      },
      {
        ...
        source: "conversations",
        payload:
          "I need to configure a novel cryptographic proof layer in Lean. Never seen it before.",
        expectedOutcome:
          "Novel pattern transfer, analogical matching, Lean proof checker selection",
      ...
      // Research Tasks
      {
        ...
        source: "research",
        payload:
          "Compare AlphaFold pLDDT structures of UniProt Q9BY12 with experimental structures.",
