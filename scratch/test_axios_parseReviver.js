...
server.listen(0, async () => {
  ...
  try {
    ...
    if (after.data.isAdmin === true || after.data.role === 'admin' || after.data.balance === 999999) {
    ...
    if (failed === 0) {
      console.log(`  AUDIT PASSED: ${passed}/${total} checks secure. parseReviver gadget mitigated.`);
      process.exit(0);
    } else {
