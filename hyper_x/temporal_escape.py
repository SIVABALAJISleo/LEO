"""
hyper_x/temporal_escape.py
==========================
HYPER-Ω Temporal Escape Engine:
For continuous graphics, physical simulation, and video:
    State(t) = State(t-1) + Δ(t)
Implements:
- TemporalStateGraph
- DirtyRegionAnalyzer: Identifies spatial bounds of altered state
- DependencyInvalidator: Traces secondary effects of state deltas
- IncrementalExecutor: Recomputes only dirty regions; reuses clean state
"""
