...
// Validates CSS color values to prevent CSS injection
const isValidCssColor = (color: string): boolean => {
  ...
  const namedColors = ['transparent', 'currentColor', 'inherit', 'initial', 'unset', 'black', 'white', 'red', 'green', 'blue', 'yellow', 'orange', 'purple', 'pink', 'gray', 'grey'];
  if (namedColors.includes(color.toLowerCase())) return true;
  // Reject anything with special characters that could enable injection
