...
const MODULE_DEFINITIONS: Record<string, string> = {
  'Quantization': 'Reduce model precision to INT8/FP16 for faster inference with minimal accuracy loss.',
...
const DEFAULT_SETTINGS: Record<string, Json> = {
  ...
  'Distributed Computing': { num_workers: 4, communication_backend: 'nccl', gradient_compression: true },
  ...
  'Memory Management': { memory_pool_size_gb: 8, fragmentation_threshold: 0.3, gc_interval_ms: 1000 },
  ...
  'Graph Optimization': { fusion_enabled: true, constant_folding: true, dead_code_elimination: true },
