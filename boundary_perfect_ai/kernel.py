...
from boundary_perfect_ai.intent_handler import BoundaryIntentHandler
from boundary_perfect_ai.reasoning_engine import BoundaryReasoningEngine
...
class BoundaryKernel:
    ...
    async def execute_pipeline(self, query: str) -> Dict[str, Any]:
        ...
        if contract["ambiguity_score"] > 0.5:
            splits = self.intent_h.split_probability(query)
