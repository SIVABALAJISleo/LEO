...
> *"Why does the application execute enormous computation in the first place, and can we mathematically or empirically prove that most of it is unnecessary while strictly satisfying the application contract?"*
