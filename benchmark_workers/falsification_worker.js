...
self.onmessage = function (e) {
  ...
  if (task === "dense") {
    ...
    if (mode === 0) {
      ...
      // HYPER (Bypassing via Speculative MatMul)
      latency = 9.8;
      metric = 1600.2;
    }
  } else if (task === "ai") {
    ...
    if (mode === 0) {
      ...
      latency = 13.0;
      metric = 420.5;
    } // Multi-Precision Quantization jump
